...
public class AmbientLight: ILighting
{
    ...
    {
        var randVec = new Vector(_rand.NextDouble() * 10 - 5, _rand.NextDouble() * 10 - 5, _rand.NextDouble() * 10 - 5);
    ...
    {
        return Color.FromArgb((int)(LColor.R * Intensity), (int)(LColor.G * Intensity), (int)(LColor.B * Intensity));
    }
}